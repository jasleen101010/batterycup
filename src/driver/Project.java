...
import fetchAllCustomers.customer_details;
import fetchTransactionsByMeterID.LastBill;
import fetchTransactionsByMonth.generate_bill;
import insertCustomer.new_customer;
import insertTransactions.calculate_bill;
import payBill.pay_bill;
...
public class Project extends JFrame implements ActionListener{
    public Project(){
        super("BatteryCup Billing System");
        ...
        JMenu master = new JMenu("OnBoarding");
        ...
        /* Second Column */
        JMenu user = new JMenu("Transactions");
        JMenuItem u2 = new JMenuItem("Add charging entry");
        JMenuItem u3 = new JMenuItem("Charging History");
        ...
        JLabel header=new JLabel("Quick Navigation Options : ");
        add(header);

        JButton b2=new JButton("Add New Charging Entry");
        ...
        JButton b3=new JButton("Fetch Charging History");
        ...
        JButton b4=new JButton("Generate Bill");
        ...
        JButton b5=new JButton("Pay Bill");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        }else if(msg.equals("Add charging entry")){
            new calculate_bill().setVisible(true);
        ...
        }else if(msg.equals("Charging History")){
            new LastBill().setVisible(true);
