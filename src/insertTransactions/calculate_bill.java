...
public class calculate_bill extends JFrame implements ActionListener
{
    ...
    public calculate_bill(){
        ...
        l1 = new JLabel("Capture Charging Entry");
        l2 = new JLabel("BatteryCup ID");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String q = "insert into bill values('"+a+"','"+c+"','"+b+"','"+p3+"','"+date+"')";
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,"Entry Captured!");
        }catch(Exception aee){
            aee.printStackTrace();
        }
